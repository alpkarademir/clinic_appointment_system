...
<head>
<meta charset="utf-8">
<title>||Hasta Yönetim Sayfası||</title>
    ...
    <div class="row">
        <div class="panel panel-primary filterable">
            <div class="panel-heading">
                <h3 class="panel-title">Hastalar</h3>
...
<!--         			</a> -->
            ...
            <table class="patient">
                <thead>
                    <tr class="filters">
                        <th><input type="text" class="form-control" placeholder="Hasta No" disabled></th>
            ...
            <c:forEach items="${listeleh}" var="i">
				...
				<td><c:out value="${i.name}" /></td>
      	      	<form:form method="get" modelAttribute="patient" action="sil2/${i.id}">
...
<!-- 		</table> -->
		...
		&nbsp; &nbsp;
				...
				<fieldset>
				<legend>Hasta Ekle</legend>
				<form:form class="form-inline" method="POST" modelAttribute="patient" action="ekleme2">
...
<hr>
   <fieldset>
   <legend>Hasta Güncelle</legend>
   <form:form method="post" modelAttribute="patient" action="guncelleme2">
				<div class="container">
<!--   						<div class="row"> -->
<!--    					 	<div class="col-sm-12"> -->
...
<!--    						</div> -->
				      ...
				      <input type="text" name= "name" class="form-control" placeholder="Hasta Adı-Soyadı">
				      </div>
				      </td>
				      <br/>
						<td><div class="form-inline">
				    	<label>Hasta No:</label>
				      <input type="text" name= "no" class="form-control" placeholder="Hasta Numarası">
				    </div>
				    </td>
				    <br/>
				   <tr><td><button type="submit" class="btn btn-success">Güncelle</button></td>
   					...
   					<td><button onclick="fonkdok()" class="btn btn-info pull-left">Doktor Kayıt</button>
   				   &nbsp; &nbsp;

...
<link type="text/css" rel="stylesheet" href="${root}/login.css" />
		...
		<div class="col-md-6 col-sm-6 col-xs-6 col-md-offset-3">
  			...
  			<div class="loginForm">
  				<div class="title">
  					...
  					<div class="col-3">
			        	<input class="effect-2" type="text"  placeholder="Username" name="username">
			            <span class="focus-border"></span>

			            <input class="effect-2" type="password" placeholder="Password" name="password">
			            <span class="focus-border"></span>
			        </div>

			        <div class="forget">
			        <a href="Login"><button class="btn btn-default btn-sm">LOGIN</button></a>
			        </div>
